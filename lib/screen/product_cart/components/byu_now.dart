import 'package:e_com_user/widget/apply_coupon_button.dart';
import 'package:e_com_user/widget/compleate_order_button.dart';
import 'package:e_com_user/widget/custom_text_field.dart';
                  ...
                  child: Consumer<CartProvider>(
                    builder: (context, cartProvider, child) {
                      return Column(
                        ...
                        children: [
                          Text('Total Amount             : \$${context.cartProvider.getCartSubTotal()}', //  Cart SubTotal
                              style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.black)),
                          Text('Total Offer Applied  : \$${cartProvider.couponCodeDiscount}',
                              style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.black)),
                          Text('Grand Total            : \$${context.cartProvider.getCartGrandTotal()}', //  GrandTotal
                ...
                Consumer<CartProvider>(
                  builder: (context, cartProvider, child) {
                    return CompleteOrderButton(
                        labelText: 'Complete Order  \$${context.cartProvider.getCartGrandTotal()} ', // Full Total
                        onPressed: () {
                          ...
                          if (context.cartProvider.buyNowFormKey.currentState!.validate()) {
                            ...
                            context.cartProvider.submitOrder(context);   //should complete call submitOrder
                            return;
                          }
                        });
                  },
