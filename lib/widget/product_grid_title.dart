...
// import 'package:e_com_user/widget/custom_network_image.dart';
...
//                   icon:  Icon(
//                     Icons.favorite,
//                     //  should complete make color dynamic
//                     // color: Color(0xFFA6A3A0),
//                     color: favoriteProvider.checkIsItemFavourite(product.sId ?? '') ? Colors.red : Color(0xFFA6A3A0),
//                   ),
//                   onPressed: () {
